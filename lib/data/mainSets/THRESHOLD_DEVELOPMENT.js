...
export const THRESHOLD_DEVELOPMENT = (energySystem, cssSecondsPer100, remainingDistanceForMainSet) => {
    ...
    const en3SetPatterns = [
        ...
        { idFormat: 'Nx1000', baseDist: 1000, maxReps: 4, rest: 'r120"', paceDesc: 'CSS -1-2s' }, // 4x1000 = 4000
        { idFormat: 'Nx800', baseDist: 800, maxReps: 5, rest: 'r90"', paceDesc: 'CSS -1-2s' },  // 5x800 = 4000
