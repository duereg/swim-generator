(function (global, factory) {
  ...
  (factory((global.swimGenerator = global.swimGenerator || {}),global._));
  ...
  var patterns = [{
    ...
    "pattern": [{ "group": "a", "interval": [4, 1] }, { "group": "b", "interval": [2, 2] }, { "group": "c", "interval": [1, 4] }, { "group": "b", "interval": [2, 2] }, { "group": "a", "interval": [4, 1] }],
    "repeat": false,
    "minTime": 400,
    "intervalSize": 4,
    "name": "100 pyramid"
    ...
    "pattern": [{ "group": "a", "interval": [3, 2] }, { "group": "b", "interval": [2, 3] }, { "group": "a", "interval": [3, 2] }, { "group": "c", "interval": [1, 6] }, { "group": "a", "interval": [3, 2] }, { "group": "b", "interval": [2, 3] }, { "group": "a", "interval": [3, 2] }],
    "repeat": false,
    "minTime": 840,
    "intervalSize": 6,
    "name": "300 binary"
  }, {
    "pattern": [{ "group": "a", "interval": [2, 4] }, { "group": "a", "interval": [2, 3] }, { "group": "a", "interval": [2, 2] }, { "group": "a", "interval": [2, 1] }],
    "repeat": false,
    "minTime": 400,
    "intervalSize": 5,
    "name": "decline"
  ...
  function getSwimByLength(secondsLeft, intervalLength, number) {
    ...
    while (!selectSwim) {
      ...
      if (numThings > 20) {
        throw new Error('fuck ' + secondsLeft + ' ' + intervalLength + ' ' + number);
      }
    }
